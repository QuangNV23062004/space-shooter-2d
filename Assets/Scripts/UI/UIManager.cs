...
public class UIManager : MonoBehaviour
{
    ...
    {
        // Debug.Log($"[UIManager] TogglePause called. pausePageIndex = {pausePageIndex}, pages.Count = {pages?.Count ?? 0}, isPaused = {isPaused}");

        // if (pausePageIndex >= 0 && pausePageIndex < pages.Count)
        // {
        //     Debug.Log($"[UIManager] Pause page reference at index {pausePageIndex}: {(pages[pausePageIndex] != null ? pages[pausePageIndex].gameObject.name : "NULL")}");
        // }
        // else
        // {
        //     Debug.LogWarning($"[UIManager] pausePageIndex {pausePageIndex} is out of range (pages.Count = {pages.Count})");
        // }
    ...
    public void GoToPage(int pageIndex, bool resetScore = false)
    {
