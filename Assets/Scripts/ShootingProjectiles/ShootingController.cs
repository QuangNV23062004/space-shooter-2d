    ...
    public void Fire()
    {
        ...
        if ((Time.timeSinceLevelLoad - lastFired) > fireRate)
        {
            ...
            if (fireEffect != null)
            {
                ...
                if (fireEffect != null)
                {
                    // Find the projectileHolder if not already set (copying the same logic used for projectiles)
                    ...
                    // Instantiate the effect and parent it to projectileHolder if it exists
                    GameObject effectInstance = Instantiate(fireEffect, transform.position, transform.rotation, null);
                    if (projectileHolder != null)
                    {
                        effectInstance.transform.SetParent(projectileHolder);
                    }
                }
